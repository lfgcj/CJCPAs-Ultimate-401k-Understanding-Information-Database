...
### Part 1: 401(k) Plan Fundamentals
- [401(k) Plan Basics](docs/401k-plan-basics.md) - Foundational concepts and overview
- [Types of 401(k) Plans](docs/401k-plan-types.md) - Traditional, Safe Harbor, SIMPLE, Solo, and more
- [Contribution Rules & Limits](docs/401k-contribution-rules.md) - IRS limits, catch-up contributions, employer matches
- [Investment Options](docs/401k-investment-options.md) - Fund types, target-date funds, self-directed options
- [Vesting Schedules](docs/401k-vesting.md) - Cliff vesting, graded vesting, immediate vesting
...
- [Fiduciary Responsibilities](docs/401k-fiduciary.md) - ERISA fiduciary duties and standards
- [ERISA Requirements](docs/401k-erisa.md) - Employee Retirement Income Security Act compliance
- [Compliance Testing](docs/401k-compliance-testing.md) - ADP, ACP, Top-Heavy, and coverage tests
- [Participant Communications](docs/401k-participant-communications.md) - Required notices and disclosures
- [Service Provider Selection](docs/401k-service-providers.md) - Choosing and monitoring providers

### Part 3: 401(k) Audit - Complete Guide
- [Audit Overview](docs/401k-audit-overview.md) - When and why audits are required
- [Audit Requirements](docs/401k-audit-requirements.md) - Threshold, timing, and regulatory requirements
- [Audit Preparation](docs/401k-audit-preparation.md) - How to prepare for an audit
- [Audit Process & Procedures](docs/401k-audit-process.md) - Step-by-step audit procedures
- [Audit Testing Procedures](docs/401k-audit-testing.md) - Detailed testing methodologies
- [Internal Controls Testing](docs/401k-internal-controls.md) - Control environment evaluation
- [Common Audit Findings](docs/401k-audit-findings.md) - Deficiencies and how to avoid them
...
- [Correction Programs](docs/401k-correction-programs.md) - EPCRS, VCP, SCP, Audit CAP
- [SECURE 2.0 Act](docs/401k-secure-2-0.md) - Comprehensive guide to all SECURE 2.0 provisions
...
|----------|-------------|
| March 15 | ADP/ACP correction deadline for QNEC refunds |
| April 15 | Employer contribution deadline (or tax extension date) |
| July 31 | Form 5500 filing deadline |
| July 31 | Form 5558 extension deadline |
| September 30 | SAR distribution deadline |
...
| Year | Provision |
|------|-----------|
| 2023 | RMD age increased to 73; Roth employer contributions available |
| 2024 | Student loan matching; Emergency savings accounts (PLESA) |
| 2025 | Mandatory auto-enrollment (new plans); Enhanced catch-up (60-63); 2-year LTPT rule |
| 2026 | HCE catch-ups must be Roth; Amendment deadline |
| 2033 | RMD age increases to 75 |

---

## Limited Scope Audit Quick Reference

### What Makes a Valid Certification?

| Requirement | Details |
|-------------|---------|
| Qualifying Institution | Bank, trust company, or insurance carrier |
| Regulated | By federal or state agency |
| Required Content | Fair values, income, gains/losses, transactions |
| Required Statements | Complete, accurate, prepared per GAAP |
| Signature | Authorized official |
| Coverage | Entire plan year |

### Audit Phases & Typical Timeline

| Phase | Duration | Key Activities |
|-------|----------|----------------|
| Pre-Engagement | 1-2 weeks | Engagement letter, PBC request |
| Planning | 3-4 weeks | Risk assessment, obtain certification |
| Fieldwork | 2-3 weeks | Testing contributions, distributions, participant data |
| Completion | 2-3 weeks | Draft financials, review, issue report |

### Common Limited Scope Testing Areas

- ✓ Contributions (deferrals, match, profit sharing)
- ✓ Distributions (terminations, hardship, RMDs)
- ✓ Participant data (eligibility, vesting, compensation)
- ✓ Loans (compliance with 72(p), defaults)
- ✓ Forfeitures (calculation, timing, use)
- ✓ Administrative expenses
- ✓ ERISA compliance (fidelity bond, notices, Form 5500)
- ✗ Investment existence (covered by certification)
- ✗ Investment valuation (covered by certification)
...
- **Auditor** conducting or preparing for an audit
- **Participant** wanting to understand your retirement plan
- **HR Professional** administering benefits
- **Financial Advisor** helping clients with retirement planning

You'll find detailed, actionable information organized for easy reference.
